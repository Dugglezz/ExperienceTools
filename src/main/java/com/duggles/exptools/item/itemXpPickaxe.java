...
public class itemXpPickaxe extends ItemPickaxe {
    public itemXpPickaxe(String unlocalizedName, ToolMaterial experienceMaterial) {
            ...
            if (p_77659_3_.isSneaking()) {
                if (p_77659_1_.getItemDamage() > 0) {
                    ...
                    if (additionalXp > 0) {
                        ...
                        if      (p_77659_3_.experienceLevel<=15)    {p_77659_3_.addExperience(16);}
                        else if (p_77659_3_.experienceLevel<=30)    {p_77659_3_.addExperience(19);}
                        else                                        {p_77659_3_.addExperience(63);}
                        p_77659_2_.playSoundAtEntity(p_77659_3_, "note.bass", 0.5F, pitch);
                    }else{
                        p_77659_2_.playSoundAtEntity(p_77659_3_, "random.fizz", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F));
                    }
                }else{p_77659_2_.playSoundAtEntity(p_77659_3_, "random.wood_click", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F));}
            }
        }
        return p_77659_1_;
    }
